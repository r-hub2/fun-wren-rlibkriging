...
if (file.exists("fit-2d-multistart.Rdata")) {
  file.remove("fit-2d-multistart.Rdata")
}


if (file.exists("fit-2d.Rdata")) {
  file.remove("fit-2d.Rdata")
}


if (file.exists("fit-2d-not01.Rdata")) {
  file.remove("fit-2d-not01.Rdata")
}
